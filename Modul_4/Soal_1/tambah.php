<?php include('koneksi.php'); ?>
		...
		<form action="" method="post">
			...
			<div class="radio">
							<label><h4><input type="radio" name="fakultas" class="form-control" value="teknik" /> Teknik</h4></label>
						</div>
						
						<div class="radio">
							<label><h4><input type="radio" name="fakultas" class="form-control" value="fisip" /> fisip</h4></label>
						</div>
						<div class="radio">
							<label><h4><input type="radio" name="fakultas" class="form-control" value="ekonomi" /> ekonomi</h4></label>
						</div>
						<div class="radio">
							<label><h4><input type="radio" name="fakultas" class="form-control" value="pertanian" /> pertanian</h4></label>
						</div>
			<div class="item form-group">
				<div  class="">
